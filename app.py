...
# الأسعار الافتراضية - مع لوجوهات كبيرة احترافية
                ...
                "platforms": {
                    "PS5": {
                        ...
                        "icon": '''<svg width="40" height="40" viewBox="0 0 24 24" fill="#003087" style="display: block; margin: 0 auto;">
                            <path d="M8.985 2.596v17.548l3.915 1.261V6.688c0-.69.304-1.151.794-.991.636.181.794.991.794.991v10.735l3.794-1.139V4.688c0-.69.318-1.151.818-.991.636.181.818.991.818.991v8.596l3.794-.567V8.688c0-.69.304-1.151.794-.991.636.181.794.991.794.991v7.735L24 17.135V1.135L8.985 2.596z"/>
                        </svg>''',
                        "accounts": {
                ...
                "platforms": {
                    "Xbox": {
                        ...
                        "icon": '''<svg width="40" height="40" viewBox="0 0 24 24" fill="#107C10" style="display: block; margin: 0 auto;">
                            ...
                            <path d="M6.43 8.69c-.58-.47-.97-1.23-.97-2.07C5.46 5.1 6.56 4 7.97 4s2.51 1.1 2.51 2.62c0 .84-.39 1.6-.97 2.07L12 12.4l2.49-3.71c-.58-.47-.97-1.23-.97-2.07C13.52 5.1 14.62 4 16.03 4s2.51 1.1 2.51 2.62c0 .84-.39 1.6-.97 2.07 1.17 1.59 1.87 3.55 1.87 5.69 0 5.52-4.48 10-10 10s-10-4.48-10-10c0-2.14.7-4.1 1.87-5.69L6.43 8.69z" fill="white"/>
                        </svg>''',
                        "accounts": {
                            "Full": {"name": "Full - حساب كامل", "price": 3500},
