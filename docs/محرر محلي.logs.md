...
"""
    ...
    # الملفات التي سيتم تجاهلها (تم إضافة ملفات .env هنا)
    ignored_files = [".env", ".env.example"]  # يمكن إضافة المزيد مثل *.log, *.db
    ...
    for root, dirs, files in os.walk("."):
        ...
        for file in files:
            ...
            if file in ignored_files or file.startswith(
                ".env."
            ):  # تجاهل .env و .env.development وهكذا
                continue
    ...
    try:
        ...
        for tool in tools:
            try:
                ...
                # هذا المتغير لم يعد مستخدماً وتم حذفه
                ...
                if tool == "flake8":
                    ...
                    # هنا هنخليه يفحص المجلد الحالي ويستثني المجلدات
                    result = subprocess.run(
...
(venv) PS C:\Users\pc\Downloads\senioraaa-main> python fix_flake8.py
...
.\analyze.py:85:80: E501 line too long (85 > 79 characters)
.\analyze.py:94:80: E501 line too long (84 > 79 characters)
...
.\app.py:368:80: E501 line too long (108 > 79 characters)
...
.\app.py:501:80: E501 line too long (108 > 79 characters)
...
.\fix_flake8.py:1:1: F401 'os' imported but unused
...
.\telegram_bot.py:1:1: F401 'json' imported but unused
.\telegram_bot.py:2:1: F401 'logging' imported but unused
.\telegram_bot.py:8:1: F401 'flask.current_app' imported but unused
.\telegram_bot.py:46:80: E501 line too long (84 > 79 characters)
.\telegram_bot.py:51:80: E501 line too long (85 > 79 characters)
.\telegram_bot.py:79:80: E501 line too long (84 > 79 characters)
.\telegram_bot.py:110:80: E501 line too long (80 > 79 characters)
.\telegram_bot.py:119:80: E501 line too long (82 > 79 characters)
.\telegram_bot.py:139:40: W291 trailing whitespace
.\telegram_bot.py:148:80: E501 line too long (82 > 79 characters)
.\telegram_bot.py:180:80: E501 line too long (81 > 79 characters)
.\telegram_bot.py:188:80: E501 line too long (83 > 79 characters)
.\telegram_bot.py:217:13: E722 do not use bare 'except'
.\telegram_bot.py:226:18: W291 trailing whitespace
.\telegram_bot.py:256:25: W291 trailing whitespace
.\telegram_bot.py:266:21: W291 trailing whitespace
.\telegram_bot.py:277:80: E501 line too long (82 > 79 characters)
.\telegram_bot.py:288:24: W291 trailing whitespace
.\telegram_bot.py:298:80: E501 line too long (80 > 79 characters)
...
def register_routes(app):
    ...
    def dashboard():
        ...
        unread_messages_count = (
            Message.query.filter_by(receiver_id=current_user.id, is_deleted=False)
        ...
        if request.method == "POST":
            try:
                ...
                if not password:
                    ...
                    errors["password"] = (
                        f'كلمة المرور يجب أن تكون {app.config.get("PASSWORD_MIN_LENGTH", 8)} أحرف على الأقل'
                    )
        ...
        if request.method == "POST":
            try:
                ...
                if not content:
                    ...
                    errors["content"] = (
                        f'الرسالة طويلة جداً (الحد الأقصى {app.config.get("MAX_MESSAGE_LENGTH", 1000)} حرف)'
                    )
                ...
                # إنشاء الرسالة
                message = Message(
                    sender_id=current_user.id, receiver_id=receiver.id, content=content
                )
    ...
    try:
        ...
        if session_token:
            user_session = UserSession.query.filter_by(
                user_id=user.id, session_token=session_token, is_active=True
            ).first()
